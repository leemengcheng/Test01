...
public class Contents {
    ...
    public class API{
        ...
        public static final String COURSE_API = "http://106.15.182.208:11376/" ;
        ...
        public static final String LOGIN = COURSE_API+"user/login.json" ;
        public static final String REGISTER =COURSE_API+"user/register.json" ;
        public static final String SMS =COURSE_API+"sms/getcode.json" ;
