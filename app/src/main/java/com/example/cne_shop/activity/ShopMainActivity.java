...
import com.example.cne_shop.fragment.QualityFragment;
import com.example.cne_shop.fragment.ShopFragment;
...
public class ShopMainActivity extends BaseActivity {
    ...
    public void initTab (){
        ...
        TabIndicator ClassifyTab = new TabIndicator(R.string.tab_assort , R.drawable.tab_quality_image, QualityFragment.class) ;
        TabIndicator ShopTab = new TabIndicator(R.string.tab_hot , R.drawable.tab_search_image, ShopFragment.class) ;
